...
<section id="listing1" class="listing1 padding_top">
  <div class="container">
    <div class="row">
	  ...
	  <form id="search" data-user-id="{{\Auth::user()->id}}">
		  <div class="col-md-4 form-horizontal search-sidebar">
			 <div class="search-heading clearfix">
			    ...
			    <div class="btn-group-separated pull-right">
			       <button type="button" class="btn btn-gray form_reset">Clear</button>
			       <button type="button" class="btn btn-primary fetch_listings">Search</button>
			    </div>
			 </div>
			 <div class="search-category">
			    ...
			    <div id="basic-search-panel" class="collapse in">
			       <div class="search-category-criteria">
			          <div class="form-horizontal">
						 ...
						 <div class="form-group">
			                <div class="col-md-12">
			                   <!-- Program -->
			                   <label for="CampusDropDown" class="control-label">Program:</label>
			                   <div class="input-group">
			                      <span class="input-group-addon">
			                      <i class="fa fa-institution fa-fw"></i>
			                      </span>
			                      <select id="CampusDropDown" class="form-control" name="program">
			                         <option value="">Any</option>
			                         @if (isset($programs) && count($programs) > 0)
									@foreach ($programs as $program)
										<option value="{{$program->id}}"
										@if (\Request::get("program") && \Request::get("program") == $program->id)
											selected
										@endif
										>{{$program->name}}</option>
									@endforeach
			       ...
			       <div class="search-category-footer text-right">
			          <button type="button" class="btn btn-success fetch_listings">Update</button>
			       </div>
			    </div>
			 </div>
			          ...
			          <div class="form-group">
			             <div class="col-md-12">
			                ...
			                <div class="input-group" id="DistanceFromCampusRange">
			                   ...
			                   <select id="MinDistanceFromCampusDropDown" class="form-control" name="distance_from">
			                   ...
			                   <span class="input-group-addon fa-fw">to</span>
			                   <select id="MaxDistanceFromCampusDropDown" class="form-control" name="distance_to">
			                      <option value="">Unlimited</option>
			                      <option value="0">0</option>
			                      <option value="1">1</option>
			                      <option value="2">2</option>
      ...
      <div class="col-md-8 col-sm-12 col-xs-12">
        <div class="row">
          <div class="col-md-9">
            <h2 class="uppercase">MY LISTINGS</h2>
            <p class="heading_space">This is a list of listings created by you.</p>
          </div>
          <div class="col-md-3">
          <form class="callus">
