	...
	<div class="container-fluid">
	   <div class="row">
		  ...
		  <div class="col-lg-9 search-results">
		     <h3 class="form-header">Search Results</h3>
		     <div>
		        <div class="listing-repeater">
		           <div id="repeater-toolbar" class="toolbar clearfix">
		              <!-- List View -->
		           ...
		           <div class="toolbar text-center" style="margin-top: 15px;">
		           ...
		           <div class="alert alert-warning pull-left" style="display: none;">
